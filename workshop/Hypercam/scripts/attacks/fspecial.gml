...
set_hitbox_value(AT_FSPECIAL, 4, HG_BASE_HITPAUSE, 20);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_BASE_HITPAUSE, 20);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_FSPECIAL, 6, HG_EXTRA_HITPAUSE, 10);
