...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_SFX, asset_get("sfx_bubblespray"));
...
//not sure yet if melee or projctile
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_LIFETIME, 60);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, 0.02);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WIDTH, 8);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HEIGHT, 8);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HIT_SFX, asset_get("sfx_bubblepop"));
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, asset_get("bubble_sprites"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 6.5);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_VSPEED, 1);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_GRAVITY, -0.05);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_AIR_FRICTION, 0.125);